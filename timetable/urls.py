...
urlpatterns = [
    ...
    # ─── Profile Viewing (hierarchy-based) ───
    path('users/profile/<str:username>/', views.view_user_profile, name='view_user_profile'),

    # ─── Professor ───
    path('professor/schedule/', views.professor_schedule, name='professor_schedule'),
    path('professor/students/', views.professor_student_list, name='professor_student_list'),
