...
class UniversityForm(forms.ModelForm):
    class Meta:
        model = University
        fields = ['name', 'code', 'established_year', 'location', 'website', 'phone', 'email', 'rector_name', 'description']
        labels = {
            'name': 'اسم الجامعة',
            'code': 'الرمز / الاختصار',
            ...
            'rector_name': 'اسم مدير الجامعة',
            'description': 'نبذة عن الجامعة',
        }
        widgets = {
            'name':             forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'مثال: جامعة السودان للعلوم والتكنولوجيا'}),
            'code':             forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'مثال: SUST'}),
            'established_year': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'مثال: 1990', 'dir': 'ltr', 'maxlength': '4', 'inputmode': 'numeric', 'pattern': '[0-9]{4}'}),
            'location':         forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'مثال: الخرطوم، السودان'}),
            'website':          forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'مثال: https://www.sust.edu', 'dir': 'ltr'}),
            'phone':            forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'مثال: +249-1-56551612', 'dir': 'ltr'}),
            'email':            forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'مثال: info@sust.edu', 'dir': 'ltr'}),
            'rector_name':      forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'اسم مدير/رئيس الجامعة'}),
            'description':      forms.Textarea(attrs={'class': 'form-control', 'rows': 4, 'placeholder': 'نبذة مختصرة عن الجامعة وتخصصاتها...'}),
        }
...
class CollegeManagerForm(forms.ModelForm):
    ...
    def clean_college(self):
        ...
        if not college:
            raise forms.ValidationError('يجب تحديد الكلية للمدير')
        return college
